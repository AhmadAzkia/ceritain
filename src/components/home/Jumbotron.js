      ...
      <div className="md:flex">
        ...
        <div className="md:p-8">
          <div className="ml-3 mt-8">
            <h1 className="ml-5 mb-2 text-3xl font-extrabold leading-none md:text-5xl">
              Ceritain Selalu Ada
            </h1>
            <h1 className="ml-5 mb-2 text-3xl font-extrabold leading-none md:text-5xl">
              Untuk
        ...
        <button class="inline-flex justify-center items-center mx-5 py-3 px-4 text-xs text-center text-white rounded-lg bg-[#5A96E3] hover:bg-blue-800 md:mx-20 md:text-sm fontLoginn">
