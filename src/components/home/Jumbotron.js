      ...
      <div className="md:flex">
        ...
        <div className="md:p-10">
          <div className="ml-1 mt-10">
            <h1 className="ml-5 text-3xl font-semibold leading-none md:text-5xl fontLoginn">
              Ceritain Selalu Ada
            </h1>
            <h1 className="ml-5 text-3xl font-semibold leading-none md:text-5xl fontLoginn">
              Untuk
            ...
            <div>
              <p className="px-4 ml-3 mt-2 md:mt-4 md:ml-3 md:mr-5 md:mb-0 sm:px-4 text-xs md:text-sm fontLoginn">
