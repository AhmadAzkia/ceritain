    ...
    <nav className="bg-white w-full shadow-transparent2 flex-col">
      <div className="flex flex-col md:flex-row">
        <div className={`flex justify-between items-center py-6 px-6 md:border-none ${isOpen ? 'border-b' : 'none'}`}>
            <div>
              <h1 className="text-2xl md:text-3xl fontLogo ml-3">
        ...
        <div className={`${isOpen ? 'block' : 'hidden'} md:flex flex-col md:flex-row justify-between w-full md:items-center`}>
          <div className="flex flex-col md:flex-row mx-auto">
            <a href="#" className="text-black block px-6 py-2 fontNavbar md:text-2xl md:px-16">Janji Tatap Muka</a>
            <a href="#" className="text-black block px-6 py-2 fontNavbar md:text-2xl md:px-16" >Testimoni</a>
            <a href="#" className="text-black block px-6 py-2 fontNavbar md:text-2xl md:px-16">Tentang Kami</a>
          </div>
          <div className="flex flex-col md:flex-row px-4 py-4">
            <button className="bgWarna rounded-full w-36 md:h-10 md:w-36 fontNavbar text-xl">Login</button>
          </div>
        </div>
      </div>  
    </nav>
